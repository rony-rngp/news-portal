                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body card-dashboard">
                                    <form class="form" id="quickForms" action="{{ route('store.post') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" class="form-control" id="title" value="{{ old('title') }}" placeholder="Enter Post">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="body" rows="5" name="description" class="form-control">{{ old('description') }}</textarea>
